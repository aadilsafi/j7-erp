...
class AdditionalCostBinDataTable extends DataTable
{
    /**
     ...
     */
    public function query(AdditionalCost $AdditionalCost): QueryBuilder
    {
        return $AdditionalCost->newQuery()->onlyTrashed();
    }
