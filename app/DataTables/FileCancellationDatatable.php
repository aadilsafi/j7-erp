...
class FileCancellationDatatable extends DataTable
{
    /**
    ...
    public function dataTable(QueryBuilder $query): EloquentDataTable
    {
        ...
        return (new EloquentDataTable($query))
            ...
            ->editColumn('cancellation_actions', function ($fileManagement) {
                if (isset($fileManagement->fileCancellation[0])) {
                    return view('app.sites.file-managements.files.files-actions.file-cancellation.actions', ['site_id' => $this->site_id, 'customer_id' => $fileManagement->stakeholder->id, 'unit_id' => $fileManagement->unit->id, 'file_cancellation_id' => $fileManagement->fileCancellation[0]['id'], 'file_refund_status' => $fileManagement->fileCancellation[0]['status'], 'file_id' =>$fileManagement->id]);
                } else {
                    return "-";
                }
            })
    ...
    {
        return 'File_Cancellation' . date('YmdHis');
    }
