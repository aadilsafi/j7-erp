...
class FourthLevelAccountsDatatable extends DataTable
{
    /**
    ...
    {
        $selectedDeletePermission =  Auth::user()->hasPermissionTo('sites.settings.accounts.fourth-level.destroy-selected');
        $editPermission =  Auth::user()->hasPermissionTo('sites.settings.accounts.fourth-level.edit');
        $destroyPermission =  Auth::user()->hasPermissionTo('sites.settings.accounts.fourth-level.destroy');
        return [
            ($selectedDeletePermission ?
    ...
    {
        return 'fourth_level_' . date('YmdHis');
    }
