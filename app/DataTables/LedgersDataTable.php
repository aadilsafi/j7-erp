...
class LedgersDataTable extends DataTable
{
    ...
    protected function getColumns(): array
    {
        return [
            ...
            Column::make('level')->title('Account Level')->addClass('text-nowrap '),
            Column::make('code')->title('Account Codes')->addClass('text-nowrap '),
            Column::make('opening_balance')->title('Opening Balance')->addClass('text-nowrap '),
            Column::make('close_balance')->title('Closing Balance')->addClass('text-nowrap '),
