        ...
        $editColumns = (new EloquentDataTable($query))
            ...
            ->editColumn('status', function ($payment_voucher) {
                ...
                if ($payment_voucher->status == 0) {
                    $status .= '  <a onClick="ApproveModal()" id="approveStatusID" payment_voucher_id="' . $payment_voucher->id . '" class="btn btn-relief-outline-success waves-effect waves-float waves-light me-1" style="margin: 5px" data-bs-toggle="tooltip" data-bs-placement="top"
