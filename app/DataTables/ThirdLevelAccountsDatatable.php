...
class ThirdLevelAccountsDatatable extends DataTable
{
    /**
    ...
    {
        return $model->newQuery()->with('modelable')->where('level', 3)->orderBy('level', 'asc');
    }

    public function html(): HtmlBuilder
    {
        $createPermission =  Auth::user()->hasPermissionTo('sites.settings.accounts.third-level.create');
    ...
    {
        $selectedDeletePermission =  Auth::user()->hasPermissionTo('sites.settings.accounts.third-level.destroy-selected');
        $editPermission =  Auth::user()->hasPermissionTo('sites.settings.accounts.third-level.edit');
        $destroyPermission =  Auth::user()->hasPermissionTo('sites.settings.accounts.third-level.destroy');
        return [
            ($selectedDeletePermission ?
    ...
    {
        return 'third_level_' . date('YmdHis');
    }
