...
class UnitShiftingController extends Controller
{
    /**
    ...
    public function index(ViewFilesDatatable $dataTable, Request $request, $site_id)
    {
        ...
        return $dataTable->with($data)->render('app.sites.file-managements.files.files-actions.unit-shifting.index', $data);
    }
