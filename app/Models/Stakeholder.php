...
class Stakeholder extends Model implements HasMedia
{
    ...
    public $rules = [
        ...
        'individual.mobile_contact' => 'exclude_if:stakeholder_as,c|exclude_if:stakeholder_type,L|required|string|min:1|max:20',
        'individual.office_contact' => 'exclude_if:stakeholder_as,c|exclude_if:stakeholder_type,L|nullable|string|min:1|max:20',
        ...
        'company.office_contact' => 'exclude_if:stakeholder_as,i|exclude_if:stakeholder_type,L|nullable|string|min:1|max:20',
