...
class Stakeholder extends Model implements HasMedia
{
    ...
    public $rules = [
        ...
        'individual.mobile_contact' => 'exclude_if:stakeholder_as,c|required|unique:stakeholders,mobile_contact',
        ...
        'company.office_contact' => 'exclude_if:stakeholder_as,i|required|unique:stakeholders,office_contact',
