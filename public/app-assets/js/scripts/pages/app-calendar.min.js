...
"rtl" == $("html").data("textdirection") && (direction = "rtl"), "laravel" === $("body").attr("data-framework") && (assetPath = $("body").attr("data-asset-path")), $(document).on("click", ".fc-sidebarToggle-button", (function (e) {
    ...
    var E = new FullCalendar.Calendar(t, {
        ...
        events: function (e, t) {
            ...
            // })), t(selectedEvents)
            selectedEvents = events.filter((function(e) {
                return e.extendedProps.calendar.toLowerCase()
            })), t(selectedEvents)
        },
        editable: !0,
        dragScroll: !0,
        ...
        eventClick: function (t) {
            //
            ! function (t) {
                (e = t.event).url  && (t.jsEvent.preventDefault(), window.open(e.url, "_blank")), a.modal("show"), d.addClass("d-none"), r.addClass("d-none"), o.removeClass("d-none"), k.removeClass("d-none"), s.val(e.title), total_amount.val(e.amount), paid_amount.val(e.paid_amount), remaining_amount.val(e.remaining_amount),  D.setDate(e.start, !0, "Y-m-d"), !0 === e.allDay ? m.prop("checked", !0) : m.prop("checked", !1), null !== e.end ? P.setDate(e.end, !0, "Y-m-d") : null, a.find(c).val(e.extendedProps.calendar).trigger("change"), void 0 !== e.extendedProps.location && h.val(e.extendedProps.location), void 0 !== e.extendedProps.guests && f.val(e.extendedProps.guests).trigger("change"), void 0 !== e.extendedProps.guests && C.val(e.extendedProps.description), k.on("click", (function () {
                    e.remove(), a.modal("hide"), $(".event-sidebar").removeClass("show"), $(".app-calendar .body-content-overlay").removeClass("show")
                }))

                $("#amount").val(e.extendedProps.amount);
                $("#paid_amount").val(e.extendedProps.paid_amount);
                $("#remaining_amount").val(e.extendedProps.remaining_amount);
