                ...
                <div class="row mb-2">
                    ...
                    <div class="col-xl-9 col-lg-9">
                        ...
                        <input type="text"
                            ...
                            id="floor_percentage" name="floor_percentage" placeholder="Floor Percentage" readonly
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-xl-9 col-lg-9">
                        ...
                        <input type="text"
                            ...
                            id="unit_percentage" name="unit_percentage" placeholder="Unit Percentage" readonly
