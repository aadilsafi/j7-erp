        ...
        <div class="row breadcrumbs-top">
            <div class="col-12">
                ...
                <div class="breadcrumb-wrapper">
                    {{ Breadcrumbs::render('sites.additional-costs.import', $site_id) }}
                </div>
            </div>
        </div>
    </div>
    ...
    <div class="row">
        ...
        <div class="col">
            <form class="form form-vertical"
                action="{{ route('sites.additional-costs.importAdcostsPreview', ['site_id' => $site_id]) }}"
                    ...
                    <div class="col position-relative">
                        <div class="card" style="border: 2px solid #7367F0; border-style: dashed; border-radius: 0;">
                            <div class="card-body">
                                ...
                                <a href="{{ route('sites.import.sample-download', ['site_id' => $site_id, 'order' => 6]) }}"
