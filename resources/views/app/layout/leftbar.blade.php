    ...
    <div class="main-menu-content">
        <ul class="navigation navigation-main" id="main-menu-navigation" data-menu="menu-navigation">
            ...
            @canany(['sites.settings.custom-fields.index', 'sites.settings.activity-logs.index',
                ...
                'sites.floors.importFloors', 'sites.types.importTypes', 'sites.additional-costs.importAdcosts',
                ...
                <li class="nav-item">
                    ...
                    <ul class="menu-content">
                        @canany(['sites.settings.import', 'sites.stakeholders.importStakeholders',
                            'sites.stakeholders.kins.importStakeholders', 'sites.floors.importFloors',
                            'sites.types.importTypes', 'sites.additional-costs.importAdcosts',
                            'sites.floors.unitsImport.importUnits', 'sites.floors.SalesPlanImport.importSalesPlan',
