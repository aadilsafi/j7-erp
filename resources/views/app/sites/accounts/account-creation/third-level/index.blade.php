...
@section('seo-breadcrumb')
    {{ Breadcrumbs::view('breadcrumbs::json-ld', 'sites.settings.accounts.third-level.index', encryptParams($site_id)) }}
@endsection

@section('page-title', '3rd Level Account')
...
@section('breadcrumbs')
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-start mb-0">3rd Level Account</h2>
                <div class="breadcrumb-wrapper">
                    {{ Breadcrumbs::render('sites.settings.accounts.third-level.index', encryptParams($site_id)) }}
                </div>
            </div>
        </div>
    </div>
...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('sites.settings.accounts.third-level.store', ['site_id' => $site_id]) }}" id="third-level-accounts" method="get">
                {{ $dataTable->table() }}
            </form>
        </div>
    </div>
...
@section('custom-js')
    ...
    <script>
        ...
        function addNew() {
            location.href = '{{ route('sites.settings.accounts.third-level.create', ['site_id' => encryptParams($site_id)]) }}';
        }
