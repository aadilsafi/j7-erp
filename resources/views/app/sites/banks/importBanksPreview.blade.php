...
@section('seo-breadcrumb')
    {{ Breadcrumbs::view('breadcrumbs::json-ld', 'sites.banks.import', encryptParams($site_id)) }}
@endsection
        ...
        <div class="row breadcrumbs-top">
            <div class="col-12">
                ...
                <div class="breadcrumb-wrapper">
                    {{ Breadcrumbs::render('sites.banks.import', encryptParams($site_id)) }}
                </div>
            </div>
        </div>
    </div>
...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('sites.banks.saveImport', ['site_id' => encryptParams($site_id)]) }}"
    ...
    <script>
        ...
        $(document).on('click', '.unit_p_input_div', function(e) {
            if (!$(this).hasClass('filedrendered')) {
                ...
                var url = "{{ route('ajax-import-banks.get.input') }}";
                $.ajax({
                    url: url,
                    type: 'GET',
                    data: {
