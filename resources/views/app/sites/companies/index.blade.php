...
@section('seo-breadcrumb')
    {{ Breadcrumbs::view('breadcrumbs::json-ld', 'sites.companies.index', $site_id) }}
@endsection
...
@section('breadcrumbs')
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-start mb-0">{{ __('Companies') }}</h2>
                <div class="breadcrumb-wrapper">
                    {{ Breadcrumbs::render('sites.companies.index', $site_id) }}
                </div>
            </div>
        </div>
    </div>
...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form action="{{ route('sites.settings.companies.destroy-selected', ['site_id' => $site_id]) }}" id="company-table-form" method="get">
                {{ $dataTable->table() }}
            </form>
        </div>
    </div>
...
@section('custom-js')
    ...
    <script>
        ...
        function addNew() {
            location.href = '{{ route('sites.settings.companies.create', ['site_id' => $site_id]) }}';
        }
