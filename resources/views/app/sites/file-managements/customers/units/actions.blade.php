<div class="d-flex justify-content-cetner align-items-center">
    ...
    @if (isset($isShowFileCreationButton) && $isShowFileCreationButton)
        @can('sites.file-managements.customers.units.files.create')
            <a class="btn btn-relief-outline-primary waves-effect waves-float waves-light" style="margin: 5px"
                ...
                href="{{ route('sites.file-managements.customers.units.files.create', ['site_id' => encryptParams($site_id), 'customer_id' => encryptParams($customer_id), 'unit_id' => encryptParams($unit_id)]) }}">
