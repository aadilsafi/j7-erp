<div class="d-flex justify-content-cetner align-items-center">
    ...
    @if (Route::current()->getName() == 'sites.file-managements.file-refund.index')
        ...
        @if (isset($checkFileRefund))
            @can('sites.file-managements.file-refund.preview')
                <a class="btn btn-relief-outline-primary waves-effect waves-float waves-light" style="margin: 5px"
            ...
            @can('sites.file-managements.file-refund.print')
            ...
            @endcan
        @else
            @can('sites.file-managements.file-refund.create')
                <a class="btn btn-relief-outline-primary waves-effect waves-float waves-light" style="margin: 5px"
    ...
    @if (Route::current()->getName() == 'sites.file-managements.file-buy-back.index')
        ...
        @if (isset($checkFileBuyBack))
            @can('sites.file-managements.file-buy-back.preview')
                <a class="btn btn-relief-outline-primary waves-effect waves-float waves-light" style="margin: 5px"
            ...
            @can('sites.file-managements.file-buy-back.print')
                <a href="javascript:void(0);"
                    class="btn btn-relief-outline-primary waves-effect waves-float waves-light me-1" style="margin: 5px"
            ...
            @endcan
        @else
            @can('sites.file-managements.file-buy-back.create')
                <a class="btn btn-relief-outline-primary waves-effect waves-float waves-light" style="margin: 5px"
    ...
    @if (Route::current()->getName() == 'sites.file-managements.file-cancellation.index')
        ...
        @if (isset($checkFileCancellation))
            @can('sites.file-managements.file-cancellation.preview')
                <a class="btn btn-relief-outline-primary waves-effect waves-float waves-light" style="margin: 5px"
            ...
            @endcan
            @can('sites.file-managements.file-cancellation.print')
                <a href="javascript:void(0);"
                    class="btn btn-relief-outline-primary waves-effect waves-float waves-light me-1" style="margin: 5px"
            ...
            @endcan
        @else
            @can('sites.file-managements.file-cancellation.create')
                <a class="btn btn-relief-outline-primary waves-effect waves-float waves-light" style="margin: 5px"
    ...
    @if (Route::current()->getName() == 'sites.file-managements.file-resale.index')
        ...
        @if (isset($checkFileResale))
            @can('sites.file-managements.file-resale.preview')
                <a class="btn btn-relief-outline-primary waves-effect waves-float waves-light" style="margin: 5px"
            ...
            @can('sites.file-managements.file-resale.print')
                <a href="javascript:void(0);"
                    class="btn btn-relief-outline-primary waves-effect waves-float waves-light me-1" style="margin: 5px"
            ...
            @endcan
        @else
            @can('sites.file-managements.file-resale.create')
                <a class="btn btn-relief-outline-primary waves-effect waves-float waves-light" style="margin: 5px"
    ...
    @if (Route::current()->getName() == 'sites.file-managements.file-title-transfer.index')
        ...
        @if (isset($checkFileTitleTransfer))
            @can('sites.file-managements.file-title-transfer.preview')
                <a class="btn btn-relief-outline-primary waves-effect waves-float waves-light" style="margin: 5px"
            ...
            @can('sites.file-managements.file-title-transfer.print')
                <a href="javascript:void(0);"
                    class="btn btn-relief-outline-primary waves-effect waves-float waves-light me-1" style="margin: 5px"
            ...
            @endcan
        @else
            @can('sites.file-managements.file-title-transfer.create')
                <a class="btn btn-relief-outline-primary waves-effect waves-float waves-light" style="margin: 5px"
