    ...
    function ApproveModal() {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                let url =
                    "{{ route('sites.file-managements.file-buy-back.approve', ['site_id' => encryptParams($site_id), 'customer_id' => encryptParams($customer_id), 'unit_id' => encryptParams($unit_id) , 'file_buy_back_id' =>encryptParams($file_refund_id)  ]) }}";
                location.href = url;
            }
        });
    }
