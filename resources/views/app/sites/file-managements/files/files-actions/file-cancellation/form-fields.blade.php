                ...
                <div class="row mb-1">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-4 position-relative">
                        ...
                        <input type="text" onchange="calculateRefundedAmount()" required name="cancellation_charges"
                            ...
                            value="{{ isset($cancellation_file) ? number_format($cancellation_file->cancellation_charges,2) : '' }}" />
                    </div>
                ...
                <div class="row mb-1">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 position-relative">
                        ...
                        <input type="text" readonly required name="amount_to_be_refunded"
                            ...
                            value="{{ isset($cancellation_file) ? number_format($cancellation_file->amount_to_be_refunded,2) : '' }}" />
                    </div>
