                ...
                <div class="row mb-1">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 position-relative">
                        ...
                        <input type="text" disabled required name="paid_amount" class="form-control form-control-lg"
                            ...
                            value="{{ isset($total_paid_amount) && (float)$total_paid_amount > 0 ? number_format($total_paid_amount,2) : '' }}" />
                    </div>
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 position-relative">
                        <div class="col-lg-12 col-md-12 col-sm-12 position-relative">
                            <textarea class="form-control form-control-lg" id="custom_comments" name="comments"
                                {{ isset($refund_file) ? 'disabled' : '' }} placeholder="Comments" rows="5">{{ isset($refund_file) ? $refund_file->comments : '' }}</textarea>
                        </div>
                    </div>
                </div>
