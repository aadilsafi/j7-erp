        ...
        <div class="card content shadow-none m-0" id="sales-agreement" role="tabpanel"
            ...
            <div class="card-body main_agreement_scroll">
                <div class="card">
                    ...
                    <div class="card-body agreement_card mb-2">
                        <h1 class="text-bold text-underline text-center p-3"><u><strong>Agreement</strong></u></h1>
                        <div class="row ">
                            <div class="col px-3">
                                <p class="h4">This Agreement is made at Plot no. MC-E1, Quaid Road West,
                                ...
                                <p> <strong> <u> J7 GLOBAL, a partnership firm having its office at Plot No. MC-E1,
                                    ...
                                    First
                                    Part </p><br>
                                <div class="text-center">AND</div><br>
                    ...
                    <div class="card">
                        <div class="card-body agreement_card">
                            <div>
                                <p><strong>NOW, THEREFORE,</strong> the Parties, intending to be legally bound, agree to
                                    the
                            ...
                            <table class="table">
                                <tbody class="custom_detail_tbl">
                                    <tr class="custom_detail_tbl">
                                        <th class="custom_detail_tbl">Agreement</th>
                                        <td class="custom_detail_tbl w-100">
                                            means this Agreement of Sale and Purchase, as may be amended or supplemented
                                            by
                                            the
                                    ...
                                    <tr class="custom_detail_tbl">
                                        <th class="custom_detail_tbl">Buyer/Vendee</th>
                                        <td class="custom_detail_tbl w-100">
                                            means the natural or legal person or persons identified as the Buyer/Vendee
                                            in
                                            this
                                            Agreement and his/her or their respective heirs, executors, successors,
                                            nominees,
                                            successors-in-title, permitted transferees and permitted assigns. Where
                                            there is
                                    ...
                                    <tr class="custom_detail_tbl">
                                        <th class="custom_detail_tbl">Common Areas</th>
                                        <td class="custom_detail_tbl w-100">
                                            means those parts of the PROJECT not physically forming a part of any Unit
                                            and
                                            are
                                            intended for the common use of all occupants or owners of Units, including
                                            inter
                                            alia all open areas, elevators, administrative office areas, security
                                            system,
                                            lobbies, Parking Area and hallways.
                                        </td>
                                    </tr>
                                    <tr class="custom_detail_tbl">
                                        <th class="custom_detail_tbl">Common Facilities</th>
                                        <td class="custom_detail_tbl w-100">
                                            means all roads, pavements, water features, installations, elevators, power
                                            backup
                                            equipment, security system, tube-well motors, improvements and common assets
                                            of
                                            the
                                    ...
                                    <tr class="custom_detail_tbl">
                                        <th class="custom_detail_tbl">Government Authority</th>
                                        <td class="custom_detail_tbl w-100">
                                            means any federal, provincial, capital or local government or authority,
                                            department,
                                            local, regulatory, statutory or housing authority, including the Office of
                                            the
                                            Cantonment Board Rawalpindi, Office of the Military Estates Officer
                                            Rawalpindi,
                                            and
                                    ...
                                    <tr class="custom_detail_tbl">
                                        <th class="custom_detail_tbl">Anticipated Date of Completion</th>
                                        <td class="custom_detail_tbl w-100">
                                            means the date or expected date as mentioned/incorporated in this Agreement,
                                            on
                                            which the Unit will be ready for handover of possession to the Buyer/Vendee,
                                            subject
                                            to the Buyer/Vendee complying with his/her obligations as per this
                                            Agreement.
                                        </td>
                                    </tr>
                                    <tr class="custom_detail_tbl">
                                        <th class="custom_detail_tbl">Completion Notice</th>
                                        <td class="custom_detail_tbl w-100">
                                    ...
                                    <tr class="custom_detail_tbl">
                                        <th class="custom_detail_tbl">Down Payment</th>
                                        <td class="custom_detail_tbl w-100">
                                            means the amount paid by the Buyer/Vendee under this Agreement, equal to __%
                                            (____
                                            percent) of the Purchase Price of the Purchased Unit, as shown in the
                                            Payment
                                            Plan-Schedule-B.
                                        </td>
                                    </tr>
                                    <tr class="custom_detail_tbl">
                                        <th class="custom_detail_tbl">Due Date</th>
                                        <td class="custom_detail_tbl w-100">
                                            means the date on or before which any payment or installment in the Payment
                                            Plan
                                            is
                                            required to be paid by the Buyer/Vendee to the Seller/Vendor in the
                                            designated
                                            bank
                                            account.
                                        </td>
                                    ...
                                    <tr class="custom_detail_tbl">
                                        <th class="custom_detail_tbl">Nominee</th>
                                        <td class="custom_detail_tbl w-100">
                                            means such person, as may be nominated by the Buyer/Vendee as the person who
                                            may
                                            facilitate in the transfer of rights and obligations of the Buyer/Vendee
                                            under
                                            the
                                    ...
                                    <tr class="custom_detail_tbl">
                                        <th class="custom_detail_tbl">Parking Area</th>
                                        <td class="custom_detail_tbl w-100">
                                    ...
                                    <tr class="custom_detail_tbl">
                                        <th class="custom_detail_tbl">Parties</th>
                                        <td class="custom_detail_tbl w-100">
                                            The Seller/Vendor and the Buyer/Vendee, where the context so permits, and
                                            each
                                            individually as a “Party”.
                                        </td>
                                    </tr>
                                    <tr class="custom_detail_tbl">
                                        <th class="custom_detail_tbl">Payment Plan</th>
                                        <td class="custom_detail_tbl w-100">
                                            means the Payment Plan in Schedule-B of the Agreement, setting out the Due
                                            Date,
                                            quantum and schedule of Installment Payments of the Purchase Price to be
                                            paid by
                                            the
                                            Buyer/Vendee.
                                        </td>
                                    ...
                                    <tr class="custom_detail_tbl">
                                        <th class="custom_detail_tbl">Property Manager</th>
                                        <td class="custom_detail_tbl w-100">
                                            means the entity formed by the Seller/Vendor, which may include the Seller,
                                            any
                                            of
                                            its affiliates or associated companies or any other company (and their
                                            respective
                                            successors in interest and assigns) charged with the maintenance, operation
                                            or
                                    ...
                                    <tr class="custom_detail_tbl">
                                        <th class="custom_detail_tbl">Project</th>
                                        <td class="custom_detail_tbl w-100">
                                            means the multistorey Building being constructed and developed by the
                                            Seller/Vendor,
                                            named and advertised as <strong>J7 Global</strong>, approved and sanctioned
                                            by
                                            the
                                    ...
                                    <tr class="custom_detail_tbl">
                                        <th class="custom_detail_tbl">Unit</th>
                                        <td class="custom_detail_tbl w-100">
                                            means the specific Unit _____, as shown in Schedule-A being the Purchased
                                            Unit,
                                            which the Buyer/Vendee has contracted to purchase pursuant to this
                                            Agreement.
                                        </td>
                                    </tr>
                                    <tr class="custom_detail_tbl">
                                        <th class="custom_detail_tbl">Service Charges</th>
                                        <td class="custom_detail_tbl w-100">
                                            means the amount payable by the Buyer/Vendee to the Property Manager on
                                            monthly
                                            basis in advance as the proportionate contribution towards the management,
                                            administration, maintenance and control of the Common Areas, Common
                                            Facilities
                                            and
                                            Parking Area, which amount shall be determined and prescribed from time to
                                            time
                                            by
                                            the Property Manager provided that Service Charges shall always be
                                            reasonable,
                                            based
                                    ...
                                    <tr class="custom_detail_tbl">
                                        <th class="custom_detail_tbl">Taxes</th>
                                        <td class="custom_detail_tbl w-100">
                                            means any federal, provincial or local taxes or levies payable on any
                                            component
                                            used
                                            for the construction of the Purchased Unit or, where the context permits,
                                            applicable
                                            on the sale or lease thereof, as may be prescribed or levied from time to
                                            time
                                            by
                    ...
                    <div class="card">
                        <div class="d-flex flex-column">
                            <div class="form-check form-switch form-check-primary">
                                <span class="h4">I Agree</span> <input type="checkbox" class="form-check-input"
                                    id="sales-agreement" name="sales-agreement" value="0" />
                            </div>
                        </div>
                    </div>
