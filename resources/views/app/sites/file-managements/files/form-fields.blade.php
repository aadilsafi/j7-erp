                    ...
                    <div class="d-flex flex-column">
                        <div class="form-check form-switch form-check-primary">
                            <span class="h4">I Agree</span> <input type="checkbox" class="form-check-input"
                                id="sales-agreement" name="sales-agreement" value="0" required>
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="row mb-1">
                                        ...
                                        <div class="col-lg-6 col-md-6 col-sm-6 position-relative">
                                            ...
                                            <input type="text" class="form-control form-control-lg"
                                                ...
                                                value="{{ number_format($salesPlan->total_price, 2) }}" disabled />
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row g-1 mb-1">
                                <div class="col-lg-6 col-md-6 col-sm-12 position-relative">
                                    ...
                                    <input type="text" class="form-control form-control-lg" id="customer_address"
                                        placeholder="Address" value="{{ $customer->address ?? '-' }}" disabled />
                                </div>

                                <div class="col-lg-6 col-md-6 col-sm-12 position-relative">
                                    <label class="form-label fs-5" for="customer_comments">Comments</label>
                                    <input type="text" class="form-control form-control-lg" id="customer_comments"
                                        placeholder="Comments" value="{{ $customer->comments ?? '-' }}" disabled />
                                </div>
                            </div>
                        </div>
                    </div>
