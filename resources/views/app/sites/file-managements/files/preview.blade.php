...
@section('seo-breadcrumb')
    {{ Breadcrumbs::view('breadcrumbs::json-ld', 'sites.file-managements.customers.units.files.show', encryptParams($site->id), encryptParams($customer->id), encryptParams($unit->id)) }}
@endsection

@section('page-title', 'Preview Files')
...
@section('breadcrumbs')
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-start mb-0">Preview Files</h2>
                <div class="breadcrumb-wrapper">
                    {{ Breadcrumbs::render('sites.file-managements.customers.units.files.show', encryptParams($site->id), encryptParams($customer->id), encryptParams($unit->id)) }}
                </div>
            </div>
        </div>
    </div>
