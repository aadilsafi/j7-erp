                        ...
                        <div class="row mb-1">
                            <div class="col-lg-3 col-md-3 col-sm-3 position-relative">
                                ...
                                <input type="text" class="form-control form-control-lg" id="sales_source_full_name"
                                    name="sales_source_name" placeholder="Sales Person"
                                ...
                                <div id="div_new_dealer">
                                    <div class="row mb-1">
                                        ...
                                        <div class="col-lg-4 col-md-4 col-sm-4 position-relative">
                                            ...
                                            <input type="text"
                                                ...
                                                id="full_name" name="dealer[full_name]"
                                    ...
                                    <div class="row mb-1">
                                        <div class="col-lg-6 col-md-6 col-sm-6 position-relative">
                                            ...
                                            <textarea class="form-control @error('address') is-invalid @enderror" name="dealer[address]" id="address"
                                                rows="3" placeholder="Stakeholder Address">{{ isset($stakeholder) ? $stakeholder->address : old('address') }}</textarea>
                                            @error('address')
                                                <div class="invalid-feedback">{{ $message }}</div>
                                            @enderror
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-6 position-relative">
                                            ...
                                            <textarea class="form-control @error('comments') is-invalid @enderror" name="dealer[comments]" id="comments"
