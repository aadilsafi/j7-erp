...
@section('seo-breadcrumb')
    {{ Breadcrumbs::view('breadcrumbs::json-ld', 'sites.file-transfer-receipts.index', $site_id) }}
@endsection

@section('page-title', __('File Transfer Receipts'))
...
@section('breadcrumbs')
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-start mb-0">File Transfer Receipts</h2>
                <div class="breadcrumb-wrapper">
                    {{ Breadcrumbs::render('sites.file-transfer-receipts.index', $site_id) }}
                </div>
            </div>
        </div>
    </div>
...
@section('custom-js')
    ...
    <script>
        ...
        function printReceiptTemplate(template_id) {
            ...
            let url =
                "{{ route('sites.file-transfer-receipts.templates.print', ['site_id' => encryptParams($site_id), 'receipts_id' => ':receipts_id', 'id' => ':id']) }}"
