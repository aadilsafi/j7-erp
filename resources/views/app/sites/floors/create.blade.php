...
@section('content')
    <form class="form form-vertical" action="{{ route('sites.floors.store', ['site_id' => encryptParams($site_id)]) }}"
        method="POST">
        ...
        <div class="row">
            <div class="col-lg-9 col-md-9 col-sm-12 position-relative">
                ...
                @csrf
                {{ view('app.sites.floors.form-fields', ['floorShortLable' => $floorShortLable, 'floorOrder' => $floorOrder, 'customFields' => $customFields]) }}
