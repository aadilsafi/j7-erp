...
@section('seo-breadcrumb')
    {{ Breadcrumbs::view('breadcrumbs::json-ld', 'sites.floors.floor-plan', encryptParams($site_id)) }}
@endsection
        ...
        <div class="row breadcrumbs-top">
            <div class="col-12">
                ...
                <div class="breadcrumb-wrapper">
                    {{ Breadcrumbs::render('sites.floors.floor-plan', encryptParams($site_id)) }}
                </div>
            </div>
        </div>
    </div>
                    ...
                    <div class="card-body">
                        <div class="row mb-1">
                            <div class="col-lg-12 col-md-12 col-sm-12 position-relative">
                                ...
                                <label class="form-label fs-5" for="floorplan_file">Floorplan File <span
                ...
                <div class="sticky-md-top top-lg-100px top-md-100px top-sm-0px" style="z-index: auto">
                    <div class="card" style="border: 2px solid #7367F0; border-style: dashed; border-radius: 0;">
                        <div class="card-body">
                            <div class="row g-1">
                                <div class="col-md-12">
                                    @can('sites.floors.floor-plan.upload')
                                        <button type="submit"
