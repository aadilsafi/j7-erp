...
@section('seo-breadcrumb')
    {{ Breadcrumbs::view(
        'breadcrumbs::json-ld',
        'sites.floors.units.create',
        encryptParams($site->id),
                        ...
                        <div class="card-body">
                            <div class="row g-1">
                                <div class="col-md-12">
                                    ...
                                    <div class="alert alert-warning alert-dismissible m-0 fade show areaAlert"
                                        role="alert">
                                    ...
                                    <hr>
                                    @can('sites.floors.units.bifurcate.store')
                                        <button
        ...
        $(document).ready(function() {
                    ...
                    $.ajax({
                        ...
                        success: function(response) {
                            if (response.success) {
                                ...
                                $('#total_price1').val(numberFormat(parseFloat(response.unit
            ...
            $.validator.addMethod("calculateArea", function(value, element) {
                ...
                if (value != '') {
                    $(parentForm.find('.tocheckArea')).each(function() {
                        ...
                        $('[name="fab-units[' + index + '][total_price]"]').val(parseFloat(
                            total_price).toFixed(2))
                        $('[name="fab-units[' + index + '][total_price1]"]').val(numberFormat(
            ...
            var validator = $("#fabUnitForm").validate({
                ...
                submitHandler: function(form) {
                    ...
                    } else if (Number($('#unit_total_area').val()) != Number($('#sub_unit_total_area')
                            .val())) {
                        $('.areaAlert').show();
