<div class="row mb-1">
    <div class="col-lg-6 col-md-6 col-sm-6 position-relative">
        ...
        <input type="text" class="form-control form-control-lg @error('site_name') is-invalid @enderror" id="site_name"
            name="site_name" placeholder="Site Nmae" readonly value="{{ $site->name }}" />
        @error('site_name')
            ...
            <div class="card-body">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-xl-9 col-lg-9">
                        <label class="form-label" style="font-size: 15px" for="corner_id">Corner Charges</label>
