        ...
        <div class="row mb-2">
            <div class="col-lg-3 col-md-4 col-sm-4 position-relative">
                ...
                @else
                    ...
                    @enderror
                    <input type="number"
                        class="form-control form-control-lg @error('net_area') is-invalid @enderror" id="net_area"
                        name="net_area" placeholder="Net Area (sqft)" min="0"
                            ...
                            <div class="col-xl-3 col-lg-3">
                                <div class="d-flex align-items-center h-100">
                                    <div class="form-check form-check-primary">
                                        ...
                                        <input type="checkbox" class="form-check-input" name="is_corner"
