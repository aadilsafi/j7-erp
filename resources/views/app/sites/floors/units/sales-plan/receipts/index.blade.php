...
@section('seo-breadcrumb')
    {{ Breadcrumbs::view('breadcrumbs::json-ld', 'sites.floors.units.sales-plans.receipts.index', encryptParams($data['site']), encryptParams($data['floor']), encryptParams($data['unit']), encryptParams($data['sales_plan_id'])) }}
@endsection
        ...
        <div class="row breadcrumbs-top">
            <div class="col-12">
                ...
                <div class="breadcrumb-wrapper">
                    {{ Breadcrumbs::render('sites.floors.units.sales-plans.receipts.index',  encryptParams($data['site']), encryptParams($data['floor']), encryptParams($data['unit']), encryptParams($data['sales_plan_id'])) }}
                </div>
            </div>
        </div>
    </div>
