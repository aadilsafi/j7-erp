...
@section('seo-breadcrumb')
    {{ Breadcrumbs::view('breadcrumbs::json-ld', 'sites.investor-deals-receipts.index', $site_id) }}
@endsection

@section('page-title', __('Investor Deals Receipts'))
...
@section('breadcrumbs')
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-start mb-0">Investor Deals Receipts</h2>
                <div class="breadcrumb-wrapper">
                    {{ Breadcrumbs::render('sites.investor-deals-receipts.index', $site_id) }}
                </div>
            </div>
        </div>
    </div>
...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form action="{{ route('sites.investor-deals-receipts.make-active-selected', ['site_id' => $site_id]) }}"
...
@section('custom-js')
    ...
    <script>
        ...
        function printReceiptTemplate(template_id) {
            ...
            let url =
                "{{ route('sites.investor-deals-receipts.templates.print', ['site_id' => encryptParams($site_id), 'receipts_id' => ':receipts_id', 'id' => ':id']) }}"
        ...
        function addNew() {
            location.href = '{{ route('sites.investor-deals-receipts.create', ['site_id' => encryptParams($site_id)]) }}';
        }
    </script>
@endsection
