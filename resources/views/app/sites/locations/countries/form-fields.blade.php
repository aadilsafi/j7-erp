<div class="row mb-1">
    <div class="col-lg-6 col-md-6 col-sm-6 position-relative">
        ...
        <input type="text" class="form-control form-control-lg @error('name') is-invalid @enderror" id="name"
            name="name" placeholder="Country" value="{{ isset($country) ? $country->name : old('name') }}" required>
        @error('name')
    ...
    <div class="col-lg-6 col-md-6 col-sm-6 position-relative">
        ...
        <input type="text" class="form-control form-control-lg @error('capital') is-invalid @enderror" id="capital"
            ...
            value="{{ isset($country) ? $country->capital : old('capital') }}" required>
        @error('capital')
            <div class="invalid-feedback">{{ $message }}</div>
        @enderror
    </div>
...
<div class="row mb-1">
    <div class="col-lg-6 col-md-6 col-sm-6 position-relative">
        ...
        <input type="text" class="form-control form-control-lg @error('short_label') is-invalid @enderror" id="short_label"
            ...
            value="{{ isset($country) ? $country->iso3 : old('short_label') }}" required>
        @error('short_label')
            <div class="invalid-feedback">{{ $message }}</div>
        @enderror
    </div>
    ...
    <div class="col-lg-6 col-md-6 col-sm-6 position-relative">
        ...
        <input type="text" class="form-control form-control-lg @error('phone_code') is-invalid @enderror" id="phone_code"
            ...
            value="{{ isset($country) ? $country->phonecode : old('phone_code') }}" required>
        @error('phone_code')
            <div class="invalid-feedback">{{ $message }}</div>
        @enderror
    </div>
