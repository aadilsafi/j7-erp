<div class="d-flex justify-content-cetner align-items-center">
    ...
    @endcan --}}
    @can('sites.payment-voucher.show')
        <a href="{{ route('sites.payment-voucher.show', ['site_id' => encryptParams($site_id), 'id' => encryptParams($id)]) }}"
            class="btn btn-relief-outline-success waves-effect waves-float waves-light me-1" style="margin: 5px"
            data-bs-toggle="tooltip" data-bs-placement="top" title="Payment Voucher Details">
