...
@section('page-title', 'Import Receipts')
...
@section('breadcrumbs')
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-start mb-0">Import Receipts</h2>
...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('sites.receipts.saveImport', ['site_id' => encryptParams($site_id)]) }}"
    ...
    <script>
        ...
        $(document).on('click', '.unit_p_input_div', function(e) {
            if (!$(this).hasClass('filedrendered')) {
                ...
                var url = "{{ route('ajax-import-receipts.get.input') }}";
                $.ajax({
                    url: url,
                    type: 'GET',
                    data: {
