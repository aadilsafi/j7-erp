                ...
                <div class="col-sm-12 col-xl-4 col-lg-6  custom_card_col main_created">
                    ...
                    <div class="col-sm-12 col-xl-4 col-lg-6  custom_card_col main_updated">
                        ...
                        <div class="col-sm-12 col-xl-4 col-lg-6 custom_card_col main_deleted">
                            @endif
                            <!-- <li class="timeline-item"> -->
                            <div class="card activity_card" style="box-shadow: 0 4px 24px 0 rgb(34 41 47 / 10%) !important;">
                                <div class="card-body">
                                    ...
                                    <div id="card_scroll" class="timeline-event custom_card_scroll">
                                        <ul class="timeline ms-50">
                                            <li class="timeline-item custom_timeline">
                                                <span class="timeline-point timeline-point-indicator"></span>
                                                <h6 class="custom_card_heading"> {{ $log->log_name }}</h6>
                                            </li>
                                            <li class="timeline-item custom_timeline custom_title_1 ">
                                                <span class="timeline-point timeline-point-warning timeline-point-indicator"></span>
                                                <h6 class="custom_card_heading"> {{ $log->description }} </h6>
                                            </li>
                                            <li class="timeline-item custom_timeline custom_title_2" style="border: none !important;">
                                        ...
                                        <div class="more-info ps-5">
                                            ...
                                            @continue
                                            @endif
                                            <p class="mb-0 custom_detail">{{ $key  }} - {{ $data}}</p>
                                            @endforeach
                                            @endif
