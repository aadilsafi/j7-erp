<div class="d-flex justify-content-cetner align-items-center">
    @can('sites.settings.bin.restore')
        <a class="btn btn-relief-outline-warning waves-effect waves-float waves-light" style="margin: 5px"
            ...
            href="{{ route('sites.settings.bin.restore', ['id' => encryptParams($id), 'site_id' => encryptParams($site_id)]) }}">
            <i class="bi bi-pencil" style="font-size: 1.1rem" class="m-10"></i>
        </a>
    @endcan
</div>
<div class="d-flex justify-content-cetner align-items-center">
    @can('sites.settings.bin.delete')
        <a class="btn btn-relief-outline-warning waves-effect waves-float waves-light" style="margin: 5px"
            data-bs-toggle="tooltip" data-bs-placement="top" title="Edit Country"
            href="{{ route('sites.settings.bin.delete', ['id' => encryptParams($id), 'site_id' => encryptParams($site_id)]) }}">
            <i class="bi bi-pencil" style="font-size: 1.1rem" class="m-10"></i>
        </a>
    @endcan
</div>
