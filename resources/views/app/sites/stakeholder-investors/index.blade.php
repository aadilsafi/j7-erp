...
@section('breadcrumbs')
    <div class="content-header-left col-md-9 col-12 mb-2">
        <div class="row breadcrumbs-top">
            <div class="col-12">
                <h2 class="content-header-title float-start mb-0">Investors Deals</h2>
                <div class="breadcrumb-wrapper">
                    {{ Breadcrumbs::render('sites.investors-deals.index', $site_id) }}
                </div>
            </div>
        </div>
    </div>
...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            ...
            <form action="{{ route('sites.investors-deals.destroy-selected', ['site_id' => $site_id]) }}"
