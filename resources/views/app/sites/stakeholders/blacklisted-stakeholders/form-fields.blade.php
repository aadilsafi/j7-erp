<div class="card" id="div-next-of-kin"
    style="border: 2px solid #7367F0; border-style: dashed; border-radius: 0;padding:10px">
    ...
    <div class="row mb-1">
        ...
        <div class="col-lg-6 col-md-6 position-relative">
            ...
            <input type="text" class="form-control form-control-lg @error('name') is-invalid @enderror"
                ...
                value="{{ isset($blacklist) ? $blacklist->name : old('name') }}" />
            @error('name')
        ...
        <div class="col-lg-6 col-md-6 position-relative">
            ...
            <input type="text" class="form-control form-control-lg @error('fatherName') is-invalid @enderror"
                id="fatherName" name="fatherName" placeholder="fatherName"
        ...
        <div class="col-lg-6 col-md-6 position-relative">
            ...
            <select class="select2" id="country" name="country">
                ...
                @foreach ($country as $countryRow)
                    <option @if ((isset($stakeholder) && $stakeholder->state->country_id) == $countryRow->id) selected @endif value="{{ $countryRow->id }}">
        ...
        <div class="col-lg-6 col-md-6 position-relative">
            <label class="form-label" style="font-size: 15px;" for="state">Select State <span
        ...
        <div class="col-lg-6 col-md-6 position-relative">
            <label class="form-label" style="font-size: 15px;" for="city">Select City <span
                    class="text-danger showRequired">*</span></label>
