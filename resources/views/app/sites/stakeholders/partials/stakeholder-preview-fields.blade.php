        ...
        <div class="">
            ...
            <div class="row mb-1">
                <div class="col-lg-6 col-md-6 position-relative">
                    ...
                    <input type="text" disabled class="form-control form-control-md " id="company_name"
                ...
                <div class="col-lg-6 col-md-6 position-relative">
                    ...
                    <input type="text" class="cp_cnic form-control form-control-md" id="registration"
                        name="company[registration]" placeholder="Registration Number" disabled
            ...
            <div class="row mb-1">
                <div class="col-lg-6 col-md-6 position-relative">
                    ...
                    <input type="text" disabled class="form-control form-control-md" id="company_ntn"
            ...
            <div class="row mb-1">
                <div class="col-lg-6 col-md-6 col-sm-6">
                    <label class="form-label fs-5" for="company_office_contact">Office Contact <span
                            class="text-danger">*</span></label>
                    <input type="tel" disabled class="form-control form-control-md ContactNoError optional_contact"
                ...
                <div class="col-lg-6 col-md-6 col-sm-6">
                    ...
                    <input type="tel" disabled class="form-control form-control-md OPTContactNoError contact"
            ...
            <div class="row mb-1">
                <div class="col-lg-6 col-md-6 position-relative">
                    ...
                    <input type="email" disabled class="form-control form-control-md" id="company_email"
                ...
                <div class="col-lg-6 col-md-6 position-relative">
                    ...
                    <input type="email" disabled class="form-control form-control-md " id="company_office_email"
            ...
            <div class="row mb-1">
                <div class="col-lg-6 col-md-6 position-relative">
                    ...
                    <input type="url" class="form-control form-control-md" id="website"
                        name="company[website]" placeholder="Website" disabled
                ...
                <div class="col-lg-6 col-md-6 position-relative">
                    ...
                    <input type="text" disabled class="form-control form-control-md" id="parent_company"
        ...
        <div class="">
            ...
            <div class="row mb-1">
                <div class="col-lg-3 col-md-3 col-sm-3 position-relative">
                    <label class="form-label fs-5" for="full_name">Full Name<span
                            class="text-danger">*</span></label>
                    <input type="text" disabled class="form-control form-control-md" id="full_name"
                ...
                <div class="col-lg-3 col-md-3 col-sm-3 position-relative">
                    <label class="form-label fs-5" for="father_name">Father / Husband Name <span
                            class="text-danger">*</span></label>
                    <input type="text" disabled class="form-control form-control-md" id="father_name"
                ...
                <div class="col-lg-3 col-md-3 col-sm-3 position-relative">
                    <label class="form-label fs-5" for="occupation">Occupation <span
                            class="text-danger">*</span></label>
                    <input type="text" disabled class="form-control form-control-md" id="occupation"
            ...
            <div class="row mb-1">
                <div class="col-lg-3 col-md-3 col-sm-3 position-relative">
                    ...
                    <input type="text" disabled class=" form-control form-control-md" id="cnic"
                ...
                <div class="col-lg-3 col-md-3 col-sm-3 position-relative">
                    ...
                    <input type="text" disabled class=" form-control form-control-md" id="passport_no"
                ...
                <div class="col-lg-3 col-md-3 col-sm-3 position-relative">
                    ...
                    <input type="number" class="form-control form-control-md" disabled id="ntn"
                ...
                <div class="col-lg-3 col-md-3 col-sm-3 position-relative">
                    <label class="form-label fs-5" for="dob">Date of Birth <span
                            class="text-danger">*</span></label>
                    <input id="dob" type="date" disabled placeholder="YYYY-MM-DD" name="individual[dob]"
            ...
            <div class="row mb-1">
                <div class="col-lg-3 col-md-3 col-sm-3 position-relative">
                    ...
                    <input type="email" disabled class="form-control form-control-md" id="individual_email"
                ...
                <div class="col-lg-3 col-md-3 col-sm-3 position-relative">
                    ...
                    <input type="email" disabled class="form-control form-control-md" id="office_email"
                ...
                <div class="col-lg-3 col-md-3 col-sm-3">
                    <label class="form-label fs-5" for="mobile_contact">Mobile Contact <span
                            class="text-danger">*</span></label>
                    <input type="tel" disabled class="form-control form-control-md" id="mobile_contact"
            ...
            <div class="row mb-1">
                <div class="col-lg-3 col-md-3 col-sm-3 position-relative">
                    ...
                    <input type="text" disabled class="form-control form-control-md" id="referred_by"
                ...
                <div class="col-lg-3 col-md-3 col-sm-3 position-relative">
                    <label class="form-label" style="font-size: 15px" for="source">Lead
                        Source</label>
                    <input type="text" disabled class="form-control form-control-md" id="source"
                ...
                <div class="col-lg-3 col-md-3 col-sm-3 position-relative">
                    <label class="form-label fs-5" for="nationality">Nationality <span
                            class="text-danger">*</span></label>
                    <input type="text" class="form-control form-control-md" id="nationality" disabled
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 position-relative mb-1">
                        ...
                        <input type="text" class="form-control form-control-md" id="residential_address_type"
                            placeholder="Address Type" disabled
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 position-relative">
                        <label class="form-label fs-5" for="residential_address">Residential Address <span
                                class="text-danger">*</span></label>
                        <textarea class="form-control" id="residential_address" disabled rows="3" placeholder="Address">{{ isset($stakeholder) ? $stakeholder->residential_address : '' }}</textarea>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-6 position-relative mb-1">
                        ...
                        <input type="text" class="form-control form-control-md" id="mailing_address_type"
                            placeholder="Mailing Address Type" disabled
                    ...
                    <div class="col-lg-12 col-md-12 col-sm-12 position-relative">
                        ...
                        <textarea class="form-control @error('mailing_address') is-invalid @enderror" name="mailing[address]"
                            id="mailing_address" rows="3" disabled placeholder="Stakeholder Address">{{ isset($stakeholder) ? $stakeholder->mailing_address : old('mailing_address') }}</textarea>
                    </div>
                </div>
            </div>
        </div>
        <div class="row mb-1">
            <div class="col-lg col-md col-sm position-relative">
                ...
                <textarea class="form-control @error('comments') is-invalid @enderror" name="comments" id="comments" rows="3"
                    placeholder="Comments" disabled>{{ isset($stakeholder) ? $stakeholder->comments : old('comments') }}</textarea>
