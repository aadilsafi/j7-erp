    ...
    <div class="card-body">
        ...
        <div class="row mb-1">
            <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12">
                <label class="form-label" style="font-size: 15px" for="teamsTree">Teams <span
        ...
        <div class="row mb-1">
            <div class="col-lg-6 col-md-6 col-sm-6 position-relative">
                <label class="form-label fs-5" for="team_name">Team Name <span class="text-danger">*</span></label>
                <input type="text" class="form-control form-control-lg @error('team_name') is-invalid @enderror"
        ...
        <div class="row mb-1 collapse" id="hasChildCard">
            <div class="col-lg-12 col-md-12 col-sm-12 position-relative">
                <label class="form-label fs-5" style="font-size: 15px" for="user_id">Users <span
                        class="text-danger">*</span></label>
